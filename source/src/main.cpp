...
uint256 hashGenesisBlock("0xc444e3d16a8605ae6aee94921e69314e5fa01161ca5822beb23a9d9c8555c72a");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Alablad: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Alablad Signed Message:\n";
...
{
    // Alablad: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Alablad: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Alablad: 3.5 days
static const int64 nTargetSpacing = 150; // Alablad: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Alablad: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Alablad: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Alablad: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa60fc53cd617f208d15c26c861e9deb1859311d5b27ba3ad2b24d8c49d00d401");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "ABD === Another illustrious Build-a-Coin cryptocurrency!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("b8d9691badce69141db8165ed46facb0c167c2704785ed0961f53cf2485ef227a8582368001593d6faf2ec663988f8cb36166c4912393e90e8c4005ece7157d2e9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1498298051;
        block.nBits    = 504365644;
        block.nNonce   = 2233771589;

        if (fTestNet)
        {
            block.nTime    = 1498298051;
            block.nNonce   = 2684644670;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xcd8470557e7c0d34e9e6efd6a06bb124aaf9c695f617cce9331753037a4b9761"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Alablad: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("AlabladMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("AlabladMiner : ProcessBlock, block not accepted");
    }
